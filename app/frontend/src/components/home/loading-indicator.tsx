export function LoadingIndicator() {
  return (
    <div className="mb-5 flex justify-start">
      <article className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white px-4 py-3">
        ...
        <div className="space-y-1.5">
          ...
          <div className="h-2 w-5/6 animate-pulse rounded bg-zinc-200 [animation-delay:120ms]" />
          <div className="h-2 w-2/3 animate-pulse rounded bg-zinc-200 [animation-delay:240ms]" />
        </div>
